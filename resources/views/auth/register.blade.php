    ...
    <div class="space-y-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <x-form-fields>
                ...
                <div class="mt-2">           
                    <x-form-input id="password" name="password" placeholder="Type your password" type="password" required/>
            ...
            <x-form-fields>
                ...
                <div class="mt-2">           
                    <x-form-input id="password_confirmation" name="password_confirmation" placeholder="Type your password again" type="password" required/>
